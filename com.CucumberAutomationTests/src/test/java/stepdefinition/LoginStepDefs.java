...
public class LoginStepDefs {
    ...
    @When("kullanici yanlis email ve sifreyi excel ile girer")
    ...
    public void kullaniciYourEmailOrPasswordIsIncorrectYazisininGoruldugunuTestEder() {
        Assert.assertTrue(loginPage.mailyadaSifreHataliYazisi.isDisplayed());
    }

    @And("kullanici adi ve kayitli email adresini girer")
    public void kullaniciAdiVeKayitliEmailAdresiniGirer() {
        loginPage=new LoginPage();
        loginPage.nameBox.sendKeys("Mario Gomez");
        loginPage.emailBox.sendKeys("almanpanzeri@gmail.com");
        loginPage.signUpButonu.click();
    ...
    public void emailAddressAlreadyExistYazisininGorunurOldugunuTestEder() {
        loginPage=new LoginPage();
        Assert.assertTrue(loginPage.EmailZatenVarYazisiElementi.isDisplayed());
    }
}
