...
public class FillDetailsStepDefs {
    ...
    public void kullanici_ayrintilari_birinci_bolum_doldurur() {
        ...
        ReusableMethods.selectByIndex(fillDetailsPage.dayDropdown,4);
        ReusableMethods.selectByIndex(fillDetailsPage.monthDropdown,5);
        ReusableMethods.selectByIndex(fillDetailsPage.yearDropdown, 25);
    }
    ...
    public void kullanici_ayrintilari_ikinci_bolum_doldurur() {
        ...
        ReusableMethods.selectByIndex(fillDetailsPage.countryDropdown,2);
